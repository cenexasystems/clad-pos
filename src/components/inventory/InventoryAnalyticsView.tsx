          ...
          <div className="flex items-center gap-2">
            ...
            <div className="relative flex-1 sm:w-56">
              ...
              <input
                ...
                className="w-full pl-8 pr-3 py-1.5 rounded-lg border border-gray-300 bg-white text-[11px] sm:text-xs font-semibold text-gray-900 placeholder:text-gray-400 placeholder:font-normal outline-none focus:border-[#0A0A0A]"
              />
            </div>
